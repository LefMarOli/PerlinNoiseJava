...
public class PerlinNoise {
  ...
  private static final Vector4D[][][][] BOUNDS_4D =
      new Vector4D[NUMBER_OF_BOUNDS_4D][NUMBER_OF_BOUNDS_4D][NUMBER_OF_BOUNDS_4D]
          [NUMBER_OF_BOUNDS_4D];
  public static final double[][][][] CORNERS = new double[2][2][2][2];
  public static final double[] DISTANCES = new double[4];
        ...
        for (int zIndex = 0; zIndex < 2; zIndex++) {
          ...
          for (int tIndex = 0; tIndex < 2; tIndex++) {
            ...
            CORNERS[xIndex][yIndex][zIndex][tIndex] =
                BOUNDS_4D[xBoundIndex][yBoundIndex][zBoundIndex][tBoundIndex]
                    .getVectorProduct(
