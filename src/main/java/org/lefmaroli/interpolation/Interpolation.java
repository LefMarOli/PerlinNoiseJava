...
public class Interpolation {
    ...
    public static double linear2D(double x1y1, double x1y2, double x2y1,
    ...
    private static double linear2DUnchecked(double x1y1, double x1y2, double x2y1,
                                            double x2y2, double muX, double muY) {
    ...
    public static double linear2DWithFade(double x1y1, double x1y2, double x2y1,
                                          double x2y2, double muX, double muY) {
        if (muX < 0.0 || muX > 1.0) {
            throw new IllegalArgumentException("Factor muX should be bounded between [0.0, 1.0]");
        }
    ...
    private static double linear2DWithFadeUnchecked(double x1y1, double x1y2, double x2y1,
                                                    double x2y2, double muX, double muY) {
    ...
    public static double linear3D(double x1y1z1, double x1y1z2, double x1y2z1, double x1y2z2, double x2y1z1,
                                  double x2y1z2,
                                  double x2y2z1, double x2y2z2, double muX, double muY, double muZ) {
        if (muX < 0.0 || muX > 1.0) {
            throw new IllegalArgumentException("Factor muX should be bounded between [0.0, 1.0]");
        }
        if (muY < 0.0 || muY > 1.0) {
        ...
        return linear3DUnchecked(x1y1z1, x1y1z2, x1y2z1, x1y2z2, x2y1z1, x2y1z2, x2y2z1, x2y2z2, muX, muY, muZ);
    }

    private static double linear3DUnchecked(double x1y1z1, double x1y1z2, double x1y2z1, double x1y2z2, double x2y1z1,
                                            double x2y1z2,
                                            double x2y2z1, double x2y2z2, double muX, double muY, double muZ) {
    ...
    public static double linear3DWithFade(double x1y1z1, double x1y1z2, double x1y2z1, double x1y2z2, double x2y1z1,
                                          double x2y1z2,
                                          double x2y2z1, double x2y2z2, double muX, double muY, double muZ) {
        if (muX < 0.0 || muX > 1.0) {
            throw new IllegalArgumentException("Factor muX should be bounded between [0.0, 1.0]");
        ...
        return linear3DWithFadeUnchecked(x1y1z1, x1y1z2, x1y2z1, x1y2z2, x2y1z1, x2y1z2, x2y2z1, x2y2z2, muX, muY, muZ);
    }

    private static double linear3DWithFadeUnchecked(double x1y1z1, double x1y1z2, double x1y2z1, double x1y2z2,
                                                    double x2y1z1, double x2y1z2,
                                                    double x2y2z1, double x2y2z2, double muX, double muY, double muZ) {
